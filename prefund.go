...
func init() {
	cli := app.Command("prefund", "(sicash) fund an owner address with utxos")
	...
	appTasks["prefund"] = func() (err error) {
		...
		/*
			...
			2. "amounts"             (string, required) A json object with addresses and amounts
			    {
			      "address":amount   (numeric or string) The sicash address is the key, the numeric amount (can be string) in SICASH is the value
			      ,...
			    }
		*/
